...
public class GetTemporadas extends AsyncTask<Void, Void, String> {
    String data = "";
    String dataParsed = "";
    String sigleParsed = "";
    @Override
    protected String doInBackground(Void... params) {
        ...
        try {
            URL url = new URL("http://rodrigolucke1-001-site1.itempurl.com/api/2/489079/temporadas");
    ...
    protected void onPostExecute(String s) {
        ...
        Pilotos.textViewPilotos.setText(this.dataParsed);
    }
