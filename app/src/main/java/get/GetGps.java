...
import com.example.f1app2020.Gps;
...
public class GetGps extends AsyncTask<Void, Void, String> {
    ...
    protected String doInBackground(Void... params) {
        ...
        try {
            URL url = new URL("http://rodrigolucke1-001-site1.itempurl.com/api/2/489079/gps");
            ...
            for (int i = 0; i <JA.length(); i ++){
                ...
                sigleParsed = JO.get("nome")+" - "+JO.get("data_gp")+"\n"+"\n";

               //sigleParsed = JO.get("grid")[0];
    ...
    protected void onPostExecute(String s) {
        ...
        Gps.textGps.setText(this.dataParsed);
    }
